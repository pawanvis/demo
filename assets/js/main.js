...
(function($) {
	...
	if($('.home-team-header').length > 0) {
		$(".home-team-header").on("click", function () {
		  $(".home-team-header, .home-team-body").removeClass("active");
		  $(this).addClass("active");
		  $(this).next(".home-team-body").addClass("active");
		});
	  }
